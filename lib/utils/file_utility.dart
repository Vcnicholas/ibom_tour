// import 'dart:io';
//
// import 'package:bill_remitter/extensions/file_extensions.dart';
...
//   resultFile = compressedXFile != null ? File(compressedXFile.path) : null;
//
//   size = resultFile?.lengthSync() ?? 0;
//
//   /// ----------------------------------------------------------------
//   AppUtility.log('Result $resultFile');
//   AppUtility.log('Result file size: ${resultFile?.sizeToKb()} KB');
